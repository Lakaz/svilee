...
class LowerCategoryAdapter(val context: Context, private val listenerDrag: LowerCategoryAdapter.dragListener) : RecyclerView.Adapter<LowerCategoryAdapter.LowerCategoryViewHolder>() {


    private var categories: MutableList<CategoryModel> = LinkedList()


    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): LowerCategoryViewHolder {
        val itemView = LayoutInflater.from(parent?.context).inflate(R.layout.list_item_category, parent, false)
        return LowerCategoryAdapter.LowerCategoryViewHolder(itemView, context, listenerDrag)

    }

    override fun getItemCount(): Int = categories.size

    override fun onBindViewHolder(holder: LowerCategoryViewHolder?, position: Int) {
    ...
    class LowerCategoryViewHolder(view: View, context: Context, private val listener: LowerCategoryAdapter.dragListener): RecyclerView.ViewHolder(view){
        ...
        fun bind(categoryModel: CategoryModel){
            ...
            itemView.setOnLongClickListener { v ->
                ...
                val shadowBuilder = LowerCategoryAdapter.MyDragShadowBuilder(image)

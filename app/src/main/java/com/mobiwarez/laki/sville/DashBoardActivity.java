...
import com.mobiwarez.laki.sville.ui.account.AccountsActivity;
import com.mobiwarez.laki.sville.ui.auth.SignInActivity;
import com.mobiwarez.laki.sville.ui.contacts.ContactsActivity;
import com.mobiwarez.laki.sville.ui.profile.ProfileActivity;
...
import com.mobiwarez.laki.sville.ui.toys.itemcategories.SearchSetUpActivity;
import com.mobiwarez.laki.sville.ui.toys.receivedToys.ReceivedToysActivity;
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (manager.findFragmentByTag(DashboardFragment.Companion.getTAG()) == null) {
            DashboardFragment dashboardFragment = DashboardFragment.Companion.newInstance();
            manager.beginTransaction().add(R.id.dash_container, dashboardFragment, DashboardFragment.Companion.getTAG()).commit();
        }
...
*/
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_profile) {
            firebaseAnalytics.logEvent("launch_profile_clicked", null);
            Intent intent = new Intent(this, ProfileActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_contacts) {
            firebaseAnalytics.logEvent("launch_contacts_clicked", null);
            Intent intent = new Intent(this, ContactsActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_given_items) {
            firebaseAnalytics.logEvent("launch_shared_toys_clicked", null);
            Intent intent = new Intent(this, SharedToysActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_received_items) {
            firebaseAnalytics.logEvent("launch_received_toys_clicked", null);
            ...
            firebaseAnalytics.logEvent("launch_account_clicked", null);
    ...
    private void loadNavHeader() {
        ...
        String userName = GetUserData.Companion.getUserDisplayName(this);
        userEmailTextView.setText(GetUserData.Companion.getUserEmail(this));
        ...
        String photoUrl = GetUserData.Companion.getUserPhotoUrl(this);

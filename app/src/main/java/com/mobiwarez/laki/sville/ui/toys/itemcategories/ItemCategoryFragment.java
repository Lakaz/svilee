...
import com.mobiwarez.laki.sville.ui.toys.list.ItemListActivity;
import com.mobiwarez.laki.sville.ui.toys.list.ItemListActivity;
...
public class ItemCategoryFragment extends Fragment implements ItemCategoryContract.View, CircleLayout.OnItemSelectedListener,
    ...
    public void showAgeGroups() {
        firebaseAnalytics.logEvent("clicked_select_age_group_search",null);
        ...
        builder.setTitle("Select Item Category")
                ...
                .setItems(R.array.age_group_array, (dialog, which) -> {
                    ...
                    firebaseAnalytics.logEvent("age_group_selected_search", bundle);
...
*/
    ...
    private void logCategorySelectedEvent(String category){
        Bundle bundle = new Bundle();
        bundle.putString("category", category);
        firebaseAnalytics.logEvent("category_selected_search", bundle);
    }
    ...
    public void onItemClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.any_icon:
                ...
                logCategorySelectedEvent(selectedCategory);
                break;

...
import com.mobiwarez.laki.sville.dagger.activity.ActivityScope
...
@ActivityScope
class RouterImpl(val activity: Activity, val fragmentManager: FragmentManager): Router {


    override fun showReceiveSetUpScreen() {
    ...
    override fun showToysScreen(category: String, ageGroup: String) {
    }

    override fun showSearchSetUpScreen() {
    }

    override fun showAddNewToyScreen() {
        val newToyIntent = Intent(activity, NewToActivity::class.java)
        activity.startActivity(newToyIntent)
    }

    override fun hideAddNewToyScreen() {
    }

    override fun showZoneScreen() {
    }

    override fun showGivenToysScreen() {
    }

    override fun showReceivedToysScreen() {

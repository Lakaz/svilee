...
//import com.mobiwarez.laki.seapp.data.remotebackend.AppEngineBackend;
...
public class MyFirebaseInstanceIdService extends FirebaseInstanceIdService{
    ...
    private void sendRegistrationToServer(String token) {
        ...
        if (GetUserData.Companion.getUserEmail(this) != null && !GetUserData.Companion.getUserEmail(this).equals("no_email")) {
            String email = GetUserData.Companion.getUserUUID(this);

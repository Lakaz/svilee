package com.mobiwarez.laki.sville.ui.auth;
...
public class SignInActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener{
    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (user != null) {
            ...
            if (GetUserData.Companion.getUserToken(this).equals("no_token")) {

            }

            else {
                if (GetUserData.Companion.getStatusOfToken(this)) {

                }

                else {
                    registerToken(GetUserData.Companion.getUserToken(this), user.getUid());
                }
            }
...
*/
    ...
    private void handleSignInResponse(int resultCode, Intent data) {
        ...
        Log.e("SIGNIN", "Sign in error", response.getError());
    }
...
*/
    ...
    private int getSelectedLogo() {
        return R.drawable.loww;//.NO_LOGO;
    }

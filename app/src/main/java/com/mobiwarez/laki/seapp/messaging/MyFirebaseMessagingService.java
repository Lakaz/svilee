...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            String chat = remoteMessage.getData().get("chatroom");
            String bod = remoteMessage.getData().get("body");

            sendNotification(bod, notTitle, chat);
        ...
        if (remoteMessage.getNotification() != null) {
            String chatRoom = remoteMessage.getNotification().getBody();
            String title = remoteMessage.getNotification().getTitle();
            //sendNotification(chatRoom, title);
...
*/
    ...
    private void broadcast(String messageBody, String title, String chatRoom) {
     ...
     */
    private void sendNotification(String messageBody, String title, String chatRoom) {

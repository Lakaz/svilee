...
class UseCaseModule {
    ...
    @Provides
    @Singleton
    fun provideAddNewToyUseCase(toyRepository: ToyRepository): AddNewToyUseCase {
        return AddNewToyUseCase(toyRepository)
    }

    @Provides
    @Singleton
    fun provideGetToysUsecase(toyRepository: ToyRepository): GetToysUseCase {
        return GetToysUseCase(toyRepository)
    }
...
*/
    ...
    interface Exposes {
        ...
        fun addNewToyUseCase(): AddNewToyUseCase

        fun getToysUsecase(): GetToysUseCase

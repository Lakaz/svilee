...
import com.mobiwarez.laki.seapp.recyclerUtils.InfiniteScrollListener
...
import com.mobiwarez.laki.seapp.ui.toys.create.NewToyViewModel
import com.mobiwarez.laki.seapp.ui.toys.receive.ReceiverManager
import com.mobiwarez.laki.seapp.util.DatabaseManger
import com.mobiwarez.laki.seapp.util.GenerateChatRoom
...
class ItemListFragment : RxBaseFragment(), ItemListAdapter.ReceiveItems, ItemsContract.View, ItemDelegateAdapter.onViewSelectedListener, LocationListener, GoogleApiClient.ConnectionCallbacks,
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        floatingActionButton!!.setOnClickListener { _ -> addToy() }
        return view
    }
...
*/
    ...
    override fun claimItem(toyViewModel: ToyViewModel?) {
        ...
        builder.setTitle("You want to receive this item: "+ toyViewModel?.toyDescription)
                .setPositiveButton("Yes") {_, _ -> receiveItem(toyViewModel!!)}
